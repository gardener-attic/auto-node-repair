...
https://github.com/kubernetes/autoscaler/blob/cluster-autorepair-1.0.0/cluster-autoscaler/clusterstate/api/types.go
*/

package api

// TODO: Remove this once Cluster autorepair api is approved.
