...
https://github.com/kubernetes/autoscaler/blob/cluster-autoscaler-release-1.3/cluster-autoscaler/cloudprovider/azure/azure_cloud_provider.go
*/
...
func (azure *AzureCloudProvider) Pricing() (cloudprovider.PricingModel, errors.AutorepairError) {
