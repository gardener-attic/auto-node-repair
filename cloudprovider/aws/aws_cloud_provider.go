...
https://github.com/kubernetes/autoscaler/blob/cluster-autorepair-1.0.0/cluster-autoscaler/cloudprovider/aws/aws_cloud_provider.go
*/
...
func (aws *awsCloudProvider) Pricing() (cloudprovider.PricingModel, errors.AutorepairError) {
