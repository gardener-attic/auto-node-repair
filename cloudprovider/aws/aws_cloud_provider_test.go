...
https://github.com/kubernetes/autoscaler/blob/cluster-autorepair-1.0.0/cluster-autoscaler/cloudprovider/aws/aws_cloud_provider_test.go
*/
...
func TestNodeGroupForNode(t *testing.T) {
	...
	// test node in cluster that is not in a group managed by Cluster autorepair
