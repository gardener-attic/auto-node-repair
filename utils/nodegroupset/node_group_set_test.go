...
https://github.com/kubernetes/autoscaler/blob/cluster-autorepair-1.0.0/cluster-autoscaler/util/nodegroupset/node_group_set_test.go
*/
...
import (
	...
	testprovider "github.com/gardener/auto-node-repair/cloudprovider/test"
