...
https://github.com/kubernetes/autoscaler/blob/cluster-autorepair-1.0.0/cluster-autoscaler/util/kubernetes/ready.go
*/
...
func IsNodeReadyAndSchedulable(node *apiv1.Node) bool {
	...
	// Mark nodes that are unschedulable as healthy, else node auto-repair starts repairing them
