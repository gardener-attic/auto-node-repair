...
https://github.com/kubernetes/autoscaler/blob/cluster-autorepair-1.0.0/cluster-autoscaler/simulator/cluster.go
*/
...
import (
	...
	//"k8s.io/auto-node-repair/utils/errors"
...
) (nodesToRemove []NodeToBeRemoved, unremovableNodes []*apiv1.Node, podReschedulingHints map[string]string, finalError errors.AutorepairError) {
